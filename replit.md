...
- **Two-Factor Authentication Feature Removed (November 15, 2025)**:
  ...
  - **UI Cleanup**: Removed 2FA setup/disable sections from Profile page and 2FA configuration from Admin Config page
  - **Focus on reCAPTCHA**: System now relies solely on Google reCAPTCHA v2 for enhanced security on login and signup pages
- **Security Enhancement - reCAPTCHA Integration (November 15, 2025)**:
  ...
  - **Security Helpers Module**: Created `server/security-helpers.ts` with function for reCAPTCHA verification
